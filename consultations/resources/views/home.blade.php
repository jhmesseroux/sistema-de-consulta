...
.btn-primary {
    /* background-color: rgb(117, 190, 0) !important; */
}
    </style>
  ...
  <div class="container-fluid d-grid gap-3 align-items-center" style="grid-template-columns: 1fr 2fr;">
    ...
    <div class="d-flex align-items-center">
      ...
      <form class="d-flex input-group  w-100 me-3 pe-4">
        ...
        <input type="search" class="form-control rounded-0" placeholder="Buscar por nombre del profesor o materia..." aria-label="Search">
    ...
    <div class="pe-3 flex-shrink-0 dropdown">
      ...
      <i class="fa-regular fa-bell  fa-xl text-white"></i>
        ...
        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
          <li><a class="dropdown-item" width="32" height="32" href="#">La consulta de las 18:30 fue cancelada</a></li>
    ...
    <div class="content__left-side p-2  w-100">
      <form action="#">
        <div class="d-flex mb-3">
          ...
          <input class="form-control rounded-0 w-full" type="search" placeholder="buscar por nombre o materia" name="search"
            id="search">
        </div>
...
<footer class="bg-primary text-info"><!-- -->
      <div class="row">
        <div class="col-2">
          <img alt="Logo de UTN FRRo" width="100%" src="https://frro.cvg.utn.edu.ar/pluginfile.php/1/theme_snap/logo/1636394775/logo-utn-siglas.png" />
        </div>
        <div class="col-5">
          <ul>
        ...
        <div class="col-5">
          <ul>
            <li><a href="/terms-and-conditions" title="Términos y condiciones">Términos y condiciones</a></li>
