<footer class="p-4 bg-blue-500 text-white shadow md:px-6 md:py-8 ">
    ...
    <span class="block text-sm  sm:text-center ">© 2022 <a href="/" class="hover:underline">SDC UTN™</a>. All Rights
        Reserved.
    </span>
</footer>
...
{{-- <div class="relative flex justify-start md:justify-center mt-6 md:items-end bg-blue-500 ">
    ...
    <div
        class="flex  py-8   px-4 md:px-6  xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
        <div class="flex  flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
            <div class="flex justify-start items-center space-x-4">
                <div class="cursor-pointer ">
                    <img src="https://utn.edu.ar/images/logo-utn.png" width="250" alt="LOGO ">
<x-application-logo />
</div>
<p class="w-60 text-xl xl:text-2xl font-semibold leading-normal text-white">UTN|Comsultas</p>
</div>
<div
    class="mt-12 xl:mt-0 grid grid-cols-1 sm:grid-cols-3 gap-y-12 sm:gap-y-0 w-full md:w-auto sm:gap-x-20 md:gap-x-28 xl:gap-8">
...
<div class="mt-12 flex  xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
    <p class="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-white">@copy 2022 | Rights Reserved
    </p>
    <div
        class="mt-10 md:mt-12 xl:mt-0 md:flex-row flex-col flex md:justify-center w-full md:w-auto justify-start items-start space-y-4 md:space-y-0 md:items-center md:space-x-4 xl:space-x-6">
