...
class ReasonCancelController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('t.firstname','t.lastname','c.teacher_id','c.id','t.avatar',s)
        ->groupBy('t.id')
        ->get();
    ...
    public function show($id)
    {
        ...
        ->select('t.firstname','t.lastname','c.teacher_id','t.avatar','t.email',
                    'c.id','c.dayOfWeek','c.time','c.place','c.link',
                    's.name')
        ->distinct()
        ->where('t.id','=',$id)
        ->get();
